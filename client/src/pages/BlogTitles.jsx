...
const BlogTitles = () => {
  ...
  const blogCategories = ['General', 'Technology', 'Health', 'Business', 'Lifestyle', 'Education', 'Food']
    ...
    const onSubmitHandler = async(e) => {
      ...
      try {
        setLoading(true)
        const prompt = `Write a 1-line introduction for the keyword ${input} in the category ${selectedCategory} and also add the line Here are some of the catchy titles ranging from beginner-friendly to more advanced: . Then, under the heading "Beginner-Friendly Titles", provide 3 simple blog titles as a numbered list. Finally, under the heading "Intermediate/Advanced Titles", provide 3 complex/expert-level titles as a numbered list. Keep the entire response concise and direct. `
